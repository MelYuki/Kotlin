package be.webmobile.kotlin.exo.collections.equipes
...
//                    for (membre in equipes.get(nomEquipe)!!){
            ...
            // les !! utilisés sont tous utilisé de facon "safe". On verifie au préalable qu'ils ne posent pas de problème
            println("on ne passe jamais par ici")
        }
